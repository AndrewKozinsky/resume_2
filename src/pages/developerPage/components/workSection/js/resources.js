...
/*export function getLogoSrc(type) {
    switch (type) {
        ...
        case 'autobuyer': return autobuyerLogo
        case 'buldoors': return buldoorsLogo
        case 'friko': return frikoLogo
        case 'kflex': return kflexLogo
        case 'labandada': return labandadaLogo
        case 'maed': return maedLogo
        case 'prana': return pranaLogo
        case 'provkus': return provkusLogo
        case 'remplast': return remplastLogo
        case 'rusheat': return rusheatLogo
        case 'teplomash': return teplomashLogo
...
/*export function getHeaderText(type) {
    switch (type) {
        ...
        case 'autobuyer': return 'Деньги под залог авто'
        case 'buldoors': return 'Двери Buldoors'
        case 'friko': return 'Сайт оборудования Friko'
        case 'kflex': return 'Сайт про термоизоляционные материалы'
        case 'labandada': return 'Сайт отеля'
        case 'maed': return 'maed'
        case 'prana': return 'Коктейли Prana'
        case 'provkus': return 'Диетическое питание «Про вкус»'
        case 'remplast': return 'Ремонт пластиковых окон'
        case 'rusheat': return 'Каталог климатической техники и материалов'
        case 'teplomash': return 'Каталог оборудования «Тепломаш»'
        case 'volcano': return 'Сайт о тепловентиляторах Vocano'
        case 'letters': return 'Различные письма'
        case 'readings': return 'Дилетантские чтения'
...
/*export function getLinkData(type, page) {
    ...
    switch (type) {
        case 'friko': obj.name = 'фрико.рус'; break;
        case 'kflex': obj.name = 'kflex.ru'; break;
        case 'rusheat': obj.name = 'rusheat.ru'; break;
        case 'teplomash': obj.name = 'тепломаш.рф'; break;
        case 'volcano': obj.name = 'volcano.ru'; break;
        case 'readings': obj.name = 'andrewkozinsky.ru/p/diletant'; break;
        case 'table': obj.name = 'andrewkozinsky.ru/p/table'; break;
    }
...
/*export function getDescription(type, page) {
    ...
    else if(type === 'kflex' && page === 'developer') {
        return 'Придумал, нарисовал и сверстал страницы и иллюстрации каталога теплоизоляционных материалов К-Flex. Код писал в стиле jQuery. Поставить на систему управления помог программист.'
    }
    else if(type === 'rusheat' && page === 'developer') {
        return 'Придумал, нарисовал и сверстал страницы и иллюстрации магазина климатического оборудования. Код писал в стиле jQuery.'
    }
    else if(type === 'teplomash' && page === 'developer') {
        return 'Придумал, нарисовал и сверстал страницы и иллюстрации каталога климатической техники «Тепломаш». Код писал в стиле jQuery.'
    }
    else if(type === 'volcano' && page === 'developer') {
        return 'Придумал, нарисовал и сверстал страницы и иллюстрации каталога про оборудование Волкано. Код писал в стиле jQuery.'
    }
    else if(type === 'readings' && page === 'developer') {
        return 'Концепция сайта «Дилетантских чтений»'
    }
    else if(type === 'table' && page === 'developer') {
        return 'Интерактивная таблица'
    }
    else if(type === 'todo' && page === 'developer') {
        return 'Небольшое приложение на MERN для ведения дел. В действии: https://www.youtube.com/watch?v=OIZQmQ4S_bk'
    }
    else if(type === 'kflex' && page === 'designer') {
        return 'Макеты сайта про теплоизоляционные материалы.'
    }
    else if(type === 'rusheat' && page === 'designer') {
        return 'Макеты сайта про климатическую технику и материалы.'
    }
    else if(type === 'letters' && page === 'designer') {
        return 'Макеты информационных и поздравительных писем отправляемых клиентам компании «Русхит».'
    }
    else if(type === 'volcano' && page === 'designer') {
        return 'Макеты сайта про оборудование Volcano.'
    }
    else if(type === 'teplomash' && page === 'designer') {
        return 'Макеты сайта про оборудование Тепломаш.'
    }
    else if(type === 'remplast' && page === 'designer') {
        return 'Макеты сайта про ремонт пластиковых окон.'
    }
    else if(type === 'labandada' && page === 'designer') {
        return 'Макеты сайта про аргентинский отель.'
    }
    else if(type === 'provkus' && page === 'designer') {
        return 'Макеты сайта про диетическое питание.'
    }
    else if(type === 'accomplies' && page === 'designer') {
        return 'Одностраничник про взыскание долгов.'
    }
    else if(type === 'autobuyer' && page === 'designer') {
        return 'Деньги под залог авто.'
    }
    else if(type === 'bukdoors' && page === 'designer') {
        return 'Сайт про двери.'
    }
    else if(type === 'austria' && page === 'designer') {
        return 'Сайт про обучение в Австрии.'
    }
    else if(type === 'prana' && page === 'designer') {
        return 'Сайт про диетическое питание.'
    }
    else {
        return 'Write text...'
    }
...
/*function getTagsArr(type) {
    switch (type) {
        ...
        case 'rusheat': return ['Адаптивная вёрстка', 'CSS', 'Bootstrap', 'Ретина']
        case 'teplomash': return ['Адаптивная вёрстка', 'CSS', 'Bootstrap', 'Ретина']
        case 'volcano': return ['Адаптивная вёрстка', 'CSS', 'Bootstrap', 'Ретина']
        case 'readings': return ['Адаптивная вёрстка', 'React', 'SCSS']
        case 'table': return ['Адаптивная вёрстка', 'React', 'SCSS']
...
/*export function createGitHubLink(type) {
    ...
    let src
    switch (type) {
        case 'readings': src = 'https://github.com/AndrewKozinsky/diletant'; break;
        case 'table': src = 'https://github.com/AndrewKozinsky/interactive-table-at-react'; break;
        case 'todo': src = 'https://github.com/AndrewKozinsky/node-todo'; break;
        default: return null
    }

    return (
        <a href={src} className={s['github-button']}>
            Код на GitHub
        </a>
    )
}*/
...
function createPicture(srcsObj, type) {
    ...
    return <picture key={srcsObj.img_1}>
        {sourses}
        <img src={srcsObj.img_1} srcSet={imageSrcSet} alt={type}/>
    </picture>
}

function getImagesSrc(type, page) {
    if(type === 'kflex' && page === 'developer') {
        return [
            {
                img_1: kflex_1_png_dev,
                img_1_2x: kflex_1_jpg_2x_dev
            },
            {
                img_1: kflex_2_jpg_dev,
                img_1_2x: kflex_2_jpg_2x_dev
            },
            {
                img_1: kflex_3_jpg_dev,
                img_1_2x: kflex_3_jpg_2x_dev
            },
            {
                img_1: kflex_4_png_dev,
                img_1_2x: kflex_4_png_2x_dev
            },
            {
                img_1: kflex_5_png_dev,
                img_1_2x: kflex_5_png_2x_dev
            },
            {
                img_1: kflex_6_png_dev,
                img_1_2x: kflex_6_png_2x_dev
            },
        ]
    }
    else if(type === 'friko' && page === 'developer') {
        return [
            {
                img_1: friko_1_png_dev,
                img_1_2x: friko_1_png_2x_dev
            },
            {
                img_1: friko_2_png_dev,
                img_1_2x: friko_2_png_2x_dev
            },
            {
                img_1: friko_3_jpg_dev,
                img_1_2x: friko_3_jpg_2x_dev
            },
            {
                img_1: friko_4_png_dev,
                img_1_2x: friko_4_png_2x_dev
            },
        ]
    }
    else if(type === 'volcano' && page === 'developer') {
        return [
            {
                img_1: volcano_1_jpg_dev,
                img_1_2x: volcano_1_jpg_2x_dev
            },
            {
                img_1: volcano_2_jpg_dev,
                img_1_2x: volcano_2_jpg_2x_dev
            },
            {
                img_1: volcano_3_jpg_dev,
                img_1_2x: volcano_3_jpg_2x_dev
            },
        ]
    }
    else if(type === 'rusheat' && page === 'developer') {
        return [
            {
                img_1: rusheat_1_jpg_dev,
                img_1_2x: rusheat_1_jpg_2x_dev
            },
            {
                img_1: rusheat_2_jpg_dev,
                img_1_2x: rusheat_2_jpg_2x_dev
            },
            {
                img_1: rusheat_3_jpg_dev,
                img_1_2x: rusheat_3_jpg_2x_dev
            },
            {
                img_1: rusheat_4_jpg_dev,
                img_1_2x: rusheat_4_jpg_2x_dev
            },
        ]
    }
    else if(type === 'teplomash' && page === 'developer') {
        return [
            {
                img_1: teplomash_1_jpg_dev,
                img_1_2x: teplomash_1_jpg_2x_dev
            },
            {
                img_1: teplomash_2_jpg_dev,
                img_1_2x: teplomash_2_jpg_2x_dev
            },
            {
                img_1: teplomash_3_jpg_dev,
                img_1_2x: teplomash_3_jpg_2x_dev
            },
            {
                img_1: teplomash_4_jpg_dev,
                img_1_2x: teplomash_4_jpg_2x_dev
            },
            {
                img_1: teplomash_5_jpg_dev,
                img_1_2x: teplomash_5_jpg_2x_dev
            },
        ]
    }
    else if(type === 'readings' && page === 'developer') {
        return [
            {
                img_1: readings_1_jpg_dev,
                img_1_2x: readings_1_jpg_2x_dev
            },
            {
                img_1: readings_2_jpg_dev,
                img_1_2x: readings_2_jpg_2x_dev
            },
            {
                img_1: readings_3_jpg_dev,
                img_1_2x: readings_3_jpg_2x_dev
            },
        ]
    }
    else if(type === 'table' && page === 'developer') {
        return [
            {
                img_1: table_1_jpg_dev,
                img_1_2x: table_1_jpg_2x_dev
            },
            {
                img_1: table_2_jpg_dev,
                img_1_2x: table_2_jpg_2x_dev
            },
        ]
    }
    else if(type === 'kflex' && page === 'designer') {
        return [
            {
                img_1: kflex_1_jpg_des,
                img_1_2x: kflex_1_jpg_2x_des
            },
            {
                img_1: kflex_2_jpg_des,
                img_1_2x: kflex_2_jpg_2x_des
            },
            {
                img_1: kflex_3_jpg_des,
                img_1_2x: kflex_3_jpg_2x_des
            },
            {
                img_1: kflex_4_png_des,
                img_1_2x: kflex_4_png_2x_des
            },
            {
                img_1: kflex_5_png_des,
                img_1_2x: kflex_5_png_2x_des
            }
        ]
    }
    else if(type === 'rusheat' && page === 'designer') {
        return [
            {
                img_1: rusheat_1_jpg_des,
                img_1_2x: rusheat_1_jpg_2x_des
            },
            {
                img_1: rusheat_2_jpg_des,
                img_1_2x: rusheat_2_jpg_2x_des
            },
            {
                img_1: rusheat_3_jpg_des,
                img_1_2x: rusheat_3_jpg_2x_des
            },
            {
                img_1: rusheat_4_jpg_des,
                img_1_2x: rusheat_4_jpg_2x_des
            },
            {
                img_1: rusheat_5_jpg_des,
                img_1_2x: rusheat_5_jpg_2x_des
            }
        ]
    }
    else if(type === 'letters' && page === 'designer') {
        return [
            {
                img_1: letters_3_jpg_des,
                img_1_2x: letters_3_jpg_2x_des
            },
            {
                img_1: letters_4_jpg_des,
                img_1_2x: letters_4_jpg_2x_des
            },
            {
                img_1: letters_5_jpg_des,
                img_1_2x: letters_5_jpg_2x_des
            },
            {
                img_1: letters_2_jpg_des,
                img_1_2x: letters_2_jpg_2x_des
            },
            {
                img_1: letters_1_jpg_des,
                img_1_2x: letters_1_jpg_2x_des
            },
        ]
    }
    else if(type === 'volcano' && page === 'designer') {
        return [
            {
                img_1: volcano_1_jpg_des,
                img_1_2x: volcano_1_jpg_2x_des,
            },
            {
                img_1: volcano_2_jpg_des,
                img_1_2x: volcano_2_jpg_2x_des,
            },
            {
                img_1: volcano_3_png_des,
                img_1_2x: volcano_3_png_2x_des,
            },
            {
                img_1: volcano_4_jpg_des,
                img_1_2x: volcano_4_jpg_2x_des,
            },
            {
                img_1: volcano_5_jpg_des,
                img_1_2x: volcano_5_jpg_2x_des,
            }
        ]
    }
    else if(type === 'teplomash' && page === 'designer') {
        return [
            {
                img_1: teplomash_1_jpg_des,
                img_1_2x: teplomash_1_jpg_2x_des,
            },
            {
                img_1: teplomash_2_png_des,
                img_1_2x: teplomash_2_png_2x_des,
            },
            {
                img_1: teplomash_3_png_des,
                img_1_2x: teplomash_3_png_2x_des,
            },
        ]
    }
    else if(type === 'remplast' && page === 'designer') {
        return [
            {
                img_1: remplast_1_jpg_des,
                img_1_2x: remplast_1_jpg_2x_des,
            },
        ]
    }
    else if(type === 'labandada' && page === 'designer') {
        return [
            {
                img_1: labandada_1_jpg_des,
            },
            {
                img_1: labandada_2_jpg_des,
            },
            {
                img_1: labandada_3_jpg_des,
            },
            {
                img_1: labandada_4_jpg_des,
            },
        ]
    }
    else if(type === 'provkus' && page === 'designer') {
        ...
        return [
            {
                img_1: autobuyer_1_jpg_des,
                img_1_2x: autobuyer_1_jpg_2x_des,
            },
        ]
    }
    else if(type === 'buldoors' && page === 'designer') {
        return [
            {
                img_1: buldoors_1_jpg_des,
            },
        ]
    }
    else if(type === 'austria' && page === 'designer') {
        ...
        return [
            {
                img_1: prana_1_jpg_des,
            },
            {
                img_1: prana_2_jpg_des,
            },
        ]
    }
    else {
